package com.joincoded.mvvmtest
...
import com.joincoded.mvvmtest.ui.theme.MVVMtestTheme
import com.joincoded.mvvmtest.viewmodel.LoanCalculatorViewModel
...
@Composable
fun LoanCalculator(viewModel: LoanCalculatorViewModel = viewModel()) {
    ...
    Column(
        ...
        Text("Max Installment : $maxInstallment")
